...
# ── VPC ──────────────────────────────────────────────────────────────
module "vpc" {
  source = "git::https://github.com/siddheshkhandar/terraform-module-vpc.git"
...
module "subnets" {
  source = "git::https://github.com/siddheshkhandar/terraform-module-subnet.git"
...
module "ec2_instances" {
  source = "git::https://github.com/siddheshkhandar/terraform--EC2.git"
...
# ── S3 Bucket ─────────────────────────────────────────────────────────
module "s3_bucket" {
  source = "git::https://github.com/siddheshkhandar/terraform--S3.git"
